<template>
  <main class="flex-col overflow-hidden relative flex bg-navy">
    ...
    >
        ...
        <div class="mx-auto">
          ...
          >
            <div class="self-stretch flex flex-row">
              ...
              <div>
                <p class="text-white font-medium text-left">
      ...
      <div class="flex flex-col mb-10 basis-1/3 py-10">
        <div class="mx-auto">
          <div class="flex grow flex-col">
            <h2 class="text-white text-xl font-semibold w-[221px]">
              ...
              <img
                src="../assets/maps.png"
                alt="maps"
                class="h-28 mt-8 mb-3 flex object-cover w[8px] justify-center"
              />
          </div>
        </div>
      </div>
    ...
    <section class="relative self-center w-full max-w-[1219px] mb-5 px-5">
      ...
      <div class="flex flex-nowrap sm:items-start justify-between">
        ...
        <div
          class="flex flex-row-reverse mt-0 space-x-3 sm:justify-center sm:mt-0"
        >
          <a
            href="#"
            class="text-gray-500 hover:text-gray-900 text-white dark:hover:text-white"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="white"
